<h1>Fixação de conhecimentos: Collections - Set</h1>

Exercícios propostos para trabalhar o conceito de Set em Java.

Toda a descrição se encontra [nesta pasta](https://github.com/cami-la/collections-java-api-2023/tree/master/src/main/java/set), em um repositório no [GitHub da Camila Cavalcante](https://github.com/cami-la/).

Conceitos trabalhados:

* [Operações Básicas](https://github.com/boaventuravh/collections-java-api-2023/tree/main/set/operacoes-basicas-set);
* Pesquisa;
* Ordenação.
